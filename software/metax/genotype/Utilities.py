...
def genotype_by_chromosome_from_args(args, snps=None):
    if args.gtex_genotype_file:
        return GTExGenotype.gtex_geno_by_chromosome(args.gtex_genotype_file, args.gtex_snp_file, snps, args.gtex_release_version, args.impute_to_mean, args.member_file)
